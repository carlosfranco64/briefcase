...
export const Projets = () => {
  ...
  return (
    <section className={`w-full min-h-screen bg-gradient-to-r ${isMode ?" from-blue-200 via-indigo-200 to-purple-200": "bg-gray-600"} ${isOpen ? "ml-0 md:ml-52" : "ml-0 md:ml-16"}`}>
      <Header />
